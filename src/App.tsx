...
const benefits = [
  ...
  },
  {
    ...
    image: "/Formulating For Sucess.jpeg",
    oldPrice: "75.00",
    newPrice: "60.00",
    highlightPrefix: "text-red-600"
  },
...
export default function App() {
  ...
  const openModal = (combo: any) => {
    ...
    trackEvent('InitiateCheckout', {
      content_name: combo.name || combo.title,
      currency: 'MYR',
      value: parseFloat(combo.newPrice || 0)
    });
  };
    ...
    <div className="min-h-screen bg-paper font-sans text-slate-900 selection:bg-brand-light selection:text-brand">
      ...
      <section className="px-6 py-40 bg-paper relative">
        <div className="mx-auto max-w-7xl">
          ...
          {/* Monthly Training Poster Section */}
          <div className="mx-auto max-w-5xl mb-24">
            <div className="overflow-hidden rounded-2xl shadow-2xl border border-line">
              <img
                src="/Monthly Training Poster.jpeg"
                alt="Monthly Training Schedule"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                newPrice: "120.00",
                image: "/Combo B.png",
                paymentLink: "https://rzp.io/rzp/15igqgV"
              },
              {
                name: "COMBO C",
                ...
                newPrice: "120.00",
                image: "/Combo C.png",
                paymentLink: "https://rzp.io/rzp/6VOkRNo"
              },
              {
                name: "COMBO D",
                courses: ["Regulatory Affairs", "Waterless Foundation"],
                ...
                <a
                  ...
                  onClick={() => {
                    trackEvent('AddPaymentInfo', {
                      content_name: selectedCombo?.name || selectedCombo?.title,
                      currency: 'MYR',
                      value: parseFloat(selectedCombo?.newPrice || 0)
                    });
                  }}
